...
Bu proje, HTML, CSS ve JavaScript kullanılarak hazırlanmış dinamik bir **menü filtreleme uygulamasıdır**.  
...
- 🍱 Tüm menü öğelerini dinamik olarak listeleme  
- 🥢 Ülke bazlı filtreleme (Korea, Japan, China, vb.)  
- 🧩 Menü verilerinin ayrı bir dosyada yönetilmesi (`menu.js`)  
- 🎨 Bootstrap veya özel CSS ile şık tasarım  
- ⚡ Vanilla JavaScript ile tamamen **dinamik DOM işlemleri**
